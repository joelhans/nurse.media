---
title: "A no-nonsense copywriting checklist to more impactful copywriting"
description: "Write more inspiring and impactful copywriting—just like a professional copywriter—with this no-nonsense copywriting checklist."
...
<div class="checklist-pull checklist-pull-info lg:absolute">
  <div class="inner">
    <p class="m-0">Be sure to check items off the checklist as you go! You can find helpful checkboxes <span class="hidden lg:inline-block">in this sidebar</span><span class="inline-block lg:hidden">beneath each item</span> and at the <a href="#the-complete-checklist">end of the post</a>. They'll even sync up so you can have it both ways!</p>
  </div>
</div>
...
<span class="text-green font-bold">*Proofish* automates social proof to boost trust, traffic, and conversions.</span>

Now we're talking.

There are two essential items to note in this process:

  1. **The copy gets messier before it gets cleaner.** You'll notice that the first few iterations tend to get longer and less concise because you're adding in features to answer the "why" question. Just remember that by the third or fourth iteration you should be turning toward *the value this product creates* rather than continuing to talk about features.
...
<div class="checklist-pull lg:absolute">
  <div class="inner">
    ...
    <div>
      <input type="checkbox" id="why-1" name="why-1">
      <label for="why-1">I asked the copy "why" five times.</label>
    </div>
  </div>
</div>
...
<div class="checklist-pull lg:absolute">
  <div class="inner">
    ...
    <div>
      <input type="checkbox" id="pyramid-1" name="pyramid-1">
      <label for="pyramid-1">I put the most important information first.</label>
    </div>
    <div>
      <input type="checkbox" id="pyramid-2" name="pyramid-2">
      <label for="pyramid-2">I answered all Five Ws.</label>
    </div>
  </div>
</div>
...
<div class="checklist-pull lg:absolute">
  <div class="inner">
    ...
    <div>
      <input type="checkbox" id="we-1" name="we-1">
      <label for="we-1">I refactored the copy to focus on "you" instead of "we".</label>
    </div>
  </div>
</div>
...
<div class="checklist-pull lg:absolute" markdown="1">
  <div class="inner" markdown="1">
    ...
    <div>
      <input type="checkbox" id="general-1" name="general-1">
      <label for="general-1">I eliminated "everyone" from my copy.</label>
    </div>
    <div>
      <input type="checkbox" id="general-2" name="general-2">
      <label for="general-2">I removed other generalist language in favor of verbiage that targets my ideal audience.</label>
    </div>
  </div>
</div>
...
<iframe src="https://giphy.com/embed/9wZdDHd4TwNLG" width="480" height="270" frameBorder="0" class="giphy-embed" allowFullScreen></iframe>
...
<div class="checklist-pull lg:absolute" markdown="1">
  <div class="inner" markdown="1">
    ...
    <div>
      <input type="checkbox" id="jargon-1" name="jargon-1">
      <label for="jargon-1">I eliminated technical, audience-reducing jargon from my copy.</label>
    </div>
    <div>
      <input type="checkbox" id="jargon-2" name="jargon-2">
      <label for="jargon-2">I ensured that I'm speaking the same language as my target audience by talking about their problems in ways they immediately understand.</label>
    </div>
  </div>
</div>
...
<div class="checklist-pull lg:absolute" markdown="1">
  <div class="inner" markdown="1">
    ...
    <div>
      <input type="checkbox" id="scan-1" name="scan-1">
      <label for="scan-1">I used paragraphs that are mostly on the shorter side.</label>
    </div>
    <div>
      <input type="checkbox" id="scan-2" name="scan-2">
      <label for="scan-2">I focused every paragraph on a single idea.</label>
    </div>
    <div>
      <input type="checkbox" id="scan-3" name="scan-3">
      <label for="scan-3">I varied sentence length to create variety. I did it.</label>
    </div>
    <div>
      <input type="checkbox" id="scan-4" name="scan-4">
      <label for="scan-4">If possible, I implemented sufficient white space around my copy to make it eye-catching.</label>
    </div>
  </div>
</div>
...
I'm a [fan of Grammarly](https://nurse.media/blog/grammarly/). If you're interested in a free alternative, be sure to check out [Hemingway](http://www.hemingwayapp.com/).

!["A screenshot of this very post in Grammarly"](grammarly.png "A screenshot of this very post in Grammarly")
...
<div class="checklist-pull lg:absolute" markdown="1">
  <div class="inner" markdown="1">
    ...
    <div>
      <input type="checkbox" id="online-1" name="online-1">
      <label for="online-1">I ran my copy through Grammarly, Hemingway, or another spelling/grammar checker.</label>
    </div>
  </div>
</div>
...
<div class="checklist-pull lg:absolute" markdown="1">
  <div class="inner" markdown="1">
    ...
    <div>
      <input type="checkbox" id="feedback-1" name="feedback-1">
      <label for="feedback-1">I sent my copy to one or more friends/colleagues/co-workers/a community and asked for constructive criticism.</label>
    </div>
  </div>
</div>
...
<span class="text-green font-bold">Our AI-powered email campaign software will get you 20% higher click-through rates!</span>

See how it feels like the product is acting on the customer? Time to flip it around:

<span class="text-green font-bold">Boost engagement by 20% on your next email campaign by employing our AI toolkit!</span>

<div class="checklist-pull lg:absolute" markdown="1">
  <div class="inner" markdown="1">
    <p>Focus on action!</p>
    <div>
      <input type="checkbox" id="action-1" name="action-1">
      <label for="action-1">I removed non-active sentences and replaced them with ones that help the customer see themselves taking action and creating change.</label>
    </div>
  </div>
</div>
...
<div class="checklist-pull lg:absolute" markdown="1">
  <div class="inner" markdown="1">
    ...
    <div>
      <input type="checkbox" id="word-1" name="word-1">
      <label for="word-1">I removed non-concise words like "really," "actually," and "very."</label>
    </div>
    <div>
      <input type="checkbox" id="word-2" name="word-2">
      <label for="word-2">I removed redundancies and tautologies.</label>
    </div>
  </div>
</div>
...
<div class="checklist-pull lg:absolute" markdown="1">
  <div class="inner" markdown="1">
    ...
    <div>
      <input type="checkbox" id="super-1" name="super-1">
      <label for="super-1">I removed all superlatives unless I had conclusive proof that my company/product/solution meets that high standard.</label>
    </div>
  </div>
</div>
...
I even wrote an [entire piece](https://nurse.media/blog/copywriting-cliches-tech/) about tech clichés new and old.

<div class="checklist-pull lg:absolute" markdown="1">
  <div class="inner" markdown="1">
    <p>Avoid clichés</p>
    <div>
      <input type="checkbox" id="cliche-1" name="cliche-1">
      <label for="cliche-1">I removed clichés from my copywriting and replaced those phrases with fresh, exciting alternatives.</label>
    </div>
  </div>
</div>
...
<div class="checklist-pull lg:absolute" markdown="1">
  <div class="inner" markdown="1">
    ...
    <div>
      <input type="checkbox" id="aloud-1" name="aloud-1">
      <label for="aloud-1">I read my work aloud and noted places where the syntax or flow was less than ideal.</label>
    </div>
    <div>
      <input type="checkbox" id="aloud-2" name="aloud-2">
      <label for="aloud-2">I made changes based on the reading and then read it again.</label>
    </div>
    <div>
      <input type="checkbox" id="aloud-3" name="aloud-3">
      <label for="aloud-3">And so on. Until it's perfect.</label>
    </div>
  </div>
</div>
...
You'll find that your copywriting is more impactful because you didn't just quickly type it out and move on. No—you <span class="text-orange font-bold italic">nurtured</span> your copy. And it shows.
...
<div class="checklist-final">
  <div class="inner">
    <p>Ask the copy "why" 5 times:</p>
    <div>
      <input type="checkbox" id="why-1_final" name="why-1">
      <label for="why-1_final">I asked the copy "why" five times.</label>
    </div>
    <p>Use the inverted pyramid:</p>
    <div>
      <input type="checkbox" id="pyramid-1_final" name="pyramid-1">
      <label for="pyramid-1_final">I put the most important information first.</label>
    </div>
    <div>
      <input type="checkbox" id="pyramid-2_final" name="pyramid-2">
      <label for="pyramid-2_final">I answered all Five Ws.</label>
    </div>
    <p>Look for an overabundance of "we" or "us":</p>
    <div>
      <input type="checkbox" id="we-1_final" name="we-1">
      <label for="we-1_final">I refactored the copy to focus on "you" instead of "we".</label>
    </div>
    <p>Eliminate generalist language:</p>
    <div>
      <input type="checkbox" id="general-1_final" name="4general-1">
      <label for="general-1_final">I eliminated "everyone" from my copy.</label>
    </div>
    <div>
      <input type="checkbox" id="general-2_final" name="general-2">
      <label for="general-2_final">I removed other generalist language in favor of verbiage that targets my ideal audience.</label>
    </div>
    <p>Remove unnecessary jargon:</p>
    <div>
      <input type="checkbox" id="jargon-1_final" name="jargon-1">
      <label for="jargon-1_final">I eliminated technical, audience-reducing jargon from my copy.</label>
    </div>
    <div>
      <input type="checkbox" id="jargon-2_final" name="jargon-2">
      <label for="jargon-2_final">I ensured that I'm speaking the same language as my target audience by talking about their problems in ways they immediately understand.</label>
    </div>
    <p>Know your keywords, distribute them evenly:</p>
    <div>
    ...
    <p>Make your copy scannable:</p>
    <div>
      <input type="checkbox" id="scan-1_final" name="scan-1_final">
      <label for="scan-1_final">I used paragraphs that are mostly on the shorter side.</label>
    </div>
    <div>
      <input type="checkbox" id="scan-2_final" name="scan-2_final">
      <label for="scan-2_final">I focused every paragraph on a single idea.</label>
    </div>
    <div>
      <input type="checkbox" id="scan-3_final" name="scan-3_final">
      <label for="scan-3_final">I varied sentence length to create variety. I did it.</label>
    </div>
    <div>
      <input type="checkbox" id="scan-4_final" name="scan-4_final">
      <label for="scan-4_final">If possible, I implemented sufficient white space around my copy to make it eye-catching.</label>
    </div>
    <p>Run your work through an online spelling/grammar checker:</p>
    <div>
      <input type="checkbox" id="online-1_final" name="online-1_final">
      <label for="online-1_final">I ran my copy through Grammarly, Hemingway, or another spelling/grammar checker.</label>
    </div>
    <p>Send it to someone you trust:</p>
    <div>
      <input type="checkbox" id="feedback-1_final" name="feedback-1_final">
      <label for="feedback-1_final">I sent my copy to one or more friends/colleagues/co-workers/a community and asked for constructive criticism.</label>
    </div>
    <p>Focus on action!</p>
    <div>
      <input type="checkbox" id="action-1_final" name="action-1_final">
      <label for="action-1_final">I removed non-active sentences and replaced them with ones that help the customer see themselves taking action and creating change.</label>
    </div>
    <p>Remove wordiness that reduces conciseness or over-qualifies</p>
    <div>
      <input type="checkbox" id="word-1_final" name="word-1_final">
      <label for="word-1_final">I removed non-concise words like "really," "actually," and "very."</label>
    </div>
    <div>
      <input type="checkbox" id="word-2_final" name="word-2_final">
      <label for="word-2_final">I removed redundancies and tautologies.</label>
    </div>
    <p>Axe the superlatives</p>
    <div>
      <input type="checkbox" id="super-1_final" name="super-1_final">
      <label for="super-1_final">I removed all superlatives unless I had conclusive proof that my company/product/solution meets that high standard.</label>
    </div>
    <p>Avoid clichés</p>
    <div>
      <input type="checkbox" id="cliche-1_final" name="cliche-1_final">
      <label for="cliche-1_final">I removed clichés from my copywriting and replaced those phrases with fresh, exciting alternatives.</label>
    </div>
    <p>Read the work out loud</p>
    <div>
      <input type="checkbox" id="aloud-1_final" name="aloud-1_final">
      <label for="aloud-1_final">I read my work aloud and noted places where the syntax or flow was less than ideal.</label>
    </div>
    <div>
      <input type="checkbox" id="aloud-2_final" name="aloud-2_final">
      <label for="aloud-2_final">I made changes based on the reading and then read it again.</label>
    </div>
    <div>
      <input type="checkbox" id="aloud-3_final" name="aloud-3_final">
      <label for="aloud-3_final">And so on. Until it's perfect.</label>
    </div>
    <button class="checklist-clear button button-orange text-white p-2 mt-4">Clear the checklist, please!</buttton>
  </div>
</div>