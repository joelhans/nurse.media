...
//   this.console.log(data.msg);

// 	// If error, add error class
// 	if (data.result === 'error') {
//     mcStatus.innerHTML = "🚨 Something went wrong! Please check that you're still connected to the Internet, have privacy/adblock extensions temporarily disabled, and entered a real email address. If these don't fix the problem, please send me an email at <a href='mailto:joel@nurse.media'>joel@nurse.media</a>."
